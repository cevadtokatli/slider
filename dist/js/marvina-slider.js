	...
	var Carousel = {
	    ...
	    animate: function (nextEl, prevEl, status, emitter) {
	        return new Promise(function (resolve) {
	            var container = emitter.get('_container');
	            var timing = emitter.get('_timing');
	            var duration = emitter.get('_duration');
	...
	var Flow = {
	    ...
	    animate: function (nextEl, prevEl, status, emitter) {
	        return new Promise(function (resolve) {
	            ...
	            var timing = emitter.get('_timing');
	            var duration = emitter.get('_duration');
	            var style = nextEl.el.getAttribute('style') || '';
